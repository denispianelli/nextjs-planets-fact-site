  ...
  return (
    <main className="mb-4 justify-center lg:flex">
        ...
        >
          <button
            ...
            className={clsx('border-t-4 border-t-transparent', {
              'border-b-4 border-b-transparent text-white/50':
                tab !== 'overview',
              'border-mars border-b-4': tab === 'overview',
            })}
          >
            overview
          </button>
          <button
            ...
            className={clsx('border-t-4 border-t-transparent', {
              'border-b-4 border-b-transparent text-white/50':
                tab !== 'structure',
              'border-mars border-b-4': tab === 'structure',
            })}
          >
            structure
          </button>
          <button
            ...
            className={clsx('border-t-4 border-t-transparent', {
              'border-b-4 border-b-transparent text-white/50':
                tab !== 'geology',
              'border-mars border-b-4': tab === 'geology',
            })}
          >
            surface
          </button>
      ...
      <article className="grid text-center lg:flex lg:w-[1110px] lg:flex-wrap">
        <div className="relative mx-auto my-[87px] flex h-[129px] w-[129px] items-center justify-center md:my-[132px] md:h-[213px]  md:w-[213px] lg:mb-[199px] lg:mt-[219px] lg:h-[336px] lg:w-[336px]">
          <Image src={activeImage} alt={data[3].name} fill />
          <Image
        ...
        <div className="mx-[24px] md:mx-[40px] md:grid md:grid-cols-2 lg:mx-0 lg:flex lg:w-[350px] lg:flex-col lg:justify-center lg:justify-self-end">
          <div>
            ...
            >
              {tab === 'overview' && data[3].overview.content}
              {tab === 'structure' && data[3].structure.content}
              {tab === 'geology' && data[3].geology.content}
            </p>
            <p
            ...
            >
              ...
              <Link
                ...
                href={data[3][tab as string]?.source || '/'}
                target="_blank"
              >
                Wikipedia{' '}
                <Image
        ...
        <div className="mt-[28px] grid gap-2 uppercase md:mx-[40px] md:grid-cols-4 md:gap-[11px] lg:col-span-2 lg:m-0 lg:flex lg:justify-center lg:gap-[30px] lg:text-left">
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            ...
            <p className="text-[20px] lg:text-[40px]">{data[3].rotation}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50 lg:mt-[20px]`}
            ...
            <p className="text-[20px] lg:text-[40px]">{data[3].revolution}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50 lg:mt-[20px]`}
            ...
            <p className="text-[20px] lg:text-[40px]">{data[3].radius}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50 lg:mt-[20px]`}
            ...
            <p className="text-[20px] lg:text-[40px]">{data[3].temperature}</p>
          </div>
        </div>
      </article>
    </main>
