    ...
    <main>
      ...
      <article className="grid text-center">
        ...
        <div className="mx-[24px]">
          <h1 className="mb-4 text-[40px] uppercase">{data[4].name}</h1>
          <p className={`${leagueSpartan.className} text-sm text-white/70`}>
            {activeTab === 'overview' && data[4].overview.content}
            {activeTab === 'structure' && data[4].structure.content}
            {activeTab === 'geology' && data[4].geology.content}
          </p>
          <p
        ...
        <div className="mt-[28px] grid gap-2 uppercase">
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2">
            ...
            <p className="text-[20px]">{data[4].rotation}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50`}
            ...
            <p className="text-[20px]">{data[4].revolution}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50`}
            ...
            <p className="text-[20px]">{data[4].radius}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50`}
            ...
            <p className="text-[20px]">{data[4].temperature}</p>
          </div>
        </div>
      </article>
    </main>
