  ...
  return (
    <main className="mb-4 justify-center lg:flex">
        ...
        >
          <button
            ...
            className={clsx('border-t-4 border-t-transparent', {
              'border-b-4 border-b-transparent text-white/50':
                tab !== 'overview',
              'border-b-4 border-mercury': tab === 'overview',
            })}
          >
            overview
          </button>
          <button
            ...
            className={clsx('border-t-4 border-t-transparent', {
              'border-b-4 border-b-transparent text-white/50':
                tab !== 'structure',
              'border-b-4 border-mercury': tab === 'structure',
            })}
          >
            structure
          </button>
          <button
            ...
            className={clsx('border-t-4 border-t-transparent', {
              'border-b-4 border-b-transparent text-white/50':
                tab !== 'geology',
              'border-b-4 border-mercury': tab === 'geology',
            })}
          >
            surface
          </button>
      ...
      <article className="grid text-center lg:flex lg:w-[1110px] lg:flex-wrap">
        <div className="relative mx-auto my-[95px] flex h-[111px] w-[111px] items-center justify-center md:my-[146px] md:h-[184px]  md:w-[184px] lg:mb-[222px] lg:mt-[242px]  lg:h-[290px] lg:w-[290px]">
          <Image src={activeImage} alt={data[0].name} fill />
          <Image
        ...
        <div className="mx-[24px] md:mx-[40px] md:grid md:grid-cols-2 lg:mx-0 lg:flex lg:w-[350px] lg:flex-col lg:justify-center lg:justify-self-end">
          <div>
            ...
            >
              {tab === 'overview' && data[0].overview.content}
              {tab === 'structure' && data[0].structure.content}
              {tab === 'geology' && data[0].geology.content}
            </p>
            <p
            ...
            >
              ...
              <Link
                ...
                href={data[0][tab as string]?.source || '/'}
                target="_blank"
              >
                Wikipedia{' '}
                <Image
        ...
        <div className="mt-[28px] grid gap-2 uppercase md:mx-[40px] md:grid-cols-4 md:gap-[11px] lg:col-span-2 lg:m-0 lg:flex lg:justify-center lg:gap-[30px] lg:text-left">
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            ...
            <p className="text-[20px] lg:text-[40px]">{data[0].rotation}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50 lg:mt-[20px]`}
            ...
            <p className="text-[20px] lg:text-[40px]">{data[0].revolution}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50 lg:mt-[20px]`}
            ...
            <p className="text-[20px] lg:text-[40px]">{data[0].radius}</p>
          </div>
          <div className="mx-[24px] flex justify-between border border-white/20 px-6 py-2 md:mx-0 md:flex-col lg:h-[128px] lg:w-[255px]">
            <h4
              className={`${leagueSpartan.className} text-h4 font-bold text-white/50 lg:mt-[20px]`}
            ...
            <p className="text-[20px] lg:text-[40px]">{data[0].temperature}</p>
          </div>
        </div>
      </article>
    </main>
